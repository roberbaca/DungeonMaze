...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("collision_fix", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("collision_fix", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "collision_fix";
		app.meta["name"] = "collision_fix";
